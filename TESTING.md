...
| Browser | Home | Popular News | Detail |  |  |
| --- | --- | --- | --- | --- | --- |
| Edge Windows11 | ![Edge Win Home](documentation/testing/browsers/edgewinhome.png) | ![Edge Win Popular](documentation/testing/browsers/edgewinpop.png) | ![Edge Win Detail](documentation/testing/browsers/edgewindetail.png) |  |  | Works as expected |
...
|  |  |  |  |  |  |
| Brave Windows11 | ![Brave Win Home](documentation/testing/browsers/bravewinhome.png) | ![Brave Win Popular](documentation/testing/browsers/bravewinpop.png) | ![Brave Win Detail](documentation/testing/browsers/bravewindetail.png) | ![Brave Win Sign up Modal](documentation/testing/browsers/bravewinup.png) ![Brave Win Sign in Modal](documentation/testing/browsers/bravewinin.png) | ![Brave Win Sign out Modal](documentation/testing/browsers/bravewinout.png) ![Brave Win Create Modal](documentation/testing/browsers/bravewincreate.png) ![Brave win Edit Modal](documentation/testing/browsers/bravewinedit.png) | Works as expected |
