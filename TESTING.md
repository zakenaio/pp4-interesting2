...
| Detail page | [W3C - Detail Page](https://validator.w3.org/nu/?showsource=yes&doc=https%3A%2F%2Fpp4-interesting-736b0c86bab7.herokuapp.com%2Fnews-details%2Ff1-testing-in-bahrain-is-on-the-way%2F#l95c28) | ![Details Validation](documentation/testing/valid-html-detail.png) | The errors I do have, are related to how ckEditor handles creation. They are all in the code generated by ckEditor |
...
| --- | --- | --- | --- | --- |
|  | ![Edge Win Home](documentation/testing/browsers/edgewinhome.png) | ![Edge Win Popular](documentation/testing/browsers/edgewinpop.png) | ![Edge Win Detail](documentation/testing/browsers/edgewindetail.png) |  |
...
| Signed out - Sign up | Sign In | Sign in - Sign out | Create | Edit |
| ![Brave Win Sign Up Modal](documentation/testing/browsers/bravewinup.png) | ![Brave Win Sign in  Modal](documentation/testing/browsers/bravewinin.png) | ![Brave Win Sign out Modal](documentation/testing/browsers/bravewinout.png) | ![Brave win Create Modal](documentation/testing/browsers/bravewincreate.png) | ![Brave win Edit Modal](documentation/testing/browsers/bravewinedit.png) |
...
| Notes |  |  |  |  |  |  |
| **Macbook 16"** |  |  |  |  |  |  |
| ![screenshot](documentation/testing/comp/macbookhome.png) | ![screenshot](documentation/testing/comp/macbookpop.png) | ![screenshot](documentation/testing/comp/macbookfooter.png) | ![screenshot](documentation/testing/comp/macbookdetail.png) | ![screenshot](documentation/testing/comp/macbookcreate.png) | ![screenshot](documentation/testing/comp/macbookedit.png) | ![screenshot](documentation/testing/comp/macbooksignup.png) |
| Notes |  |  |  |  |  |  |
| **Tablet DEV** |  |  |  |  |  |  |
